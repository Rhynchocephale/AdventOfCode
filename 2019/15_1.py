...
def goThatWay(direction, position):
...
while True:
	...
	if out >= 0:
		if out == 0:
			grid[goThatWay(direction, position)] = '#'
		elif out == 1:
			position = goThatWay(direction, position)
			grid[position] = '.'
		elif out == 2:
			grid[goThatWay(direction, position)] = '!'
			print('FINI !')
